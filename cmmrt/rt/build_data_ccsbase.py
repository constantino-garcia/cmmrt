...
def main():
    inputPath = '/home/ceu/research/repos/cmm_rt_shared/ccsbase/'
    outputPath = '/home/ceu/research/repos/cmm_rt_shared/ccsbase/2D/'
    ...
    inputFileName = inputPath + "ccsbase.csv"
